...
const HeroQuotesList = async ({ lng }) => {
    ...
    return (
        <conteiner className='mx-auto w-full md:w-[512px] xl:w-[732px] mt-[24px] md:mt-[116px]  flex flex-col xl:justify-center'>
            <div className='flex justify-end md:justify-start xl:justify-between md:gap-[88px]'>
                ...
                <div className='flex w-[166px] md:w-[176px] xl:[166px] mb-[95px] md:mb-[136px] items-center'>
            ...
            <div className='flex xl:justify-between'>
                <div className='flex justify-end md:justify-start md:mt-[16px]'>
                    <div className='flex w-[207px] md:w-[208px] xl:[204px] items-center'>
                        <p className={`${inter.className} font-medium italic text-base text-white-500`}>
                            {t('hero.quote-4')}
                        </p>

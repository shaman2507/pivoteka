...
const Taste = async ({ lng }) => { 
    ...
    return (
        <section className='mt-[100px] h-[660px] bg-black-500'>
            <div className='flex flex-col md:flex-row pt-[100px] md:pt-[120px] md:items-center justify-center md:justify-between'>
                <h2 className={`${lora.className} mb-[40px] w-[328px] md:w-[380px] font-medium text-[36px] md:text-[40px] xl:text-[64px] text-center md:text-left leading-[1.2] md:leading-[1.0] text-orange-600`}>
                    {t('taste.title')}
                </h2>
            ...
            <div className='mx-auto w-[328px] md:w-full h-[244px] md:h-full bg-white-600'>
                ...
                <div className='mb-[100px] md:hidden'>
                    <SwiperBtn />
                </div>
            </div>
        </section>

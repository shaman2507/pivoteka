    ...
    return (
        <div className='mt-[52px] flex flex-col gap-[12px]'>
            <Link className={`${className} flex`} href="https://maps.app.goo.gl/3vWqMVqiBofgAFiu9" onClick={onClick}>
                ...
                <p className={`${inter.className} pl-[4px] my-auto font-medium text-[16px] leading-[1.2] text-white-500 hover:text-yellow-600`}>Budva</p>
            </Link>
            <Link className={`${className} flex`} href="tel:+382222222222" onClick={onClick}>
                ...
                <p className={`${inter.className} pl-[4px] my-auto font-medium text-[16px] leading-[1.2] text-white-500 hover:text-yellow-600`}>+382222222222</p>
            </Link>
        </div>
    );
};
